...
const uri =
  "mongodb+srv://Rubel:pVyqQKPBx8auCtKM@cluster0.l479m.mongodb.net/Rasel?retryWrites=true&w=majority";
...
client.connect((err) => {
  const collection = client.db("Rasel").collection("Eros");
  const collections = client.db("Rasel").collection("Raselimage");
  const ImageCollection = client.db("Rasel").collection("RaselNewImage");
